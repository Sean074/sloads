...
(design note `docs/25_notes/39_derive_override_note.md`, agreed 2026-08-26;
...
**Key decisions.** LF-1 … LF-12 in `docs/25_notes/40_landing_load_factor_note.md` (AGREED
...
4. **The retired hops are recorded, not merely deleted.** The archaeology table that
   ...
   `docs/90_record/11_completed_development_to_0.5.0.md`, and `migrations.py`'s docstring
   points at it.
