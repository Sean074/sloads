# Completed Development — archive to 0.8.3

**Frozen archive.** Everything that shipped before the **0.8.3** release cut
(2026-09-13) and after the 0.8.2 cut, moved here verbatim on 2026-09-14 at the
0.8.4 cut (`RELEASE_PROCESS.md` §4 step 3; design note
[`../25_notes/28_doc_volume_reduction_note.md`](../25_notes/28_doc_volume_reduction_note.md)). The
0.8.3 release-cut block itself stays in the live record,
[`00_completed_development.md`](00_completed_development.md), which holds the
current cycle plus the previous release's cut; the 0.8.2 cycle and the 0.8.1
cut are in
...
the 0.8.0 cycle and the 0.7.1 and 0.7.2 cuts in
