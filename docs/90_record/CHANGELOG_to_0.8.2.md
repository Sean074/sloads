# Changelog archive — releases up to and including 0.8.2
...
- **Design note 48 records the LIMIT-channel contract, agreed (tier S, 2026-09-04).**
  ...
  `docs/25_notes/48_limit_channel_note.md` states the rulings that follow
...
- **The notes directory and the backlog agree with reality at the 0.8.2 cut
  ...
  `90_record/44_backlog_state_narrative_to_2026-08-29.md` per the file's own
...
- **Four process-doc corrections from the 2026-09-04 project review (issue
  ...
  `docs/90_record/49_git_flow_guide_to_2026-08-16.docx` — it advertised the
...
- **A design note can no longer claim work is unbuilt after it has shipped
  ...
  carried their pre-build status: [note 32](docs/25_notes/32_oracle_gui_note.md)
...
- **Design note 32 (oracle GUI) agreed; the GUI freeze lifted for its work (tier S, 2026-08-19).**
  `docs/25_notes/32_oracle_gui_note.md` moves `PROPOSED` → `AGREED`, making the
...
- **LRA beam-model design review** (backlog band B, steps 12/13/14; design note
  `docs/25_notes/24_lra_beam_model_review_note.md`, **agreed 2026-08-15**, no
...
- **Doc volume: history archived to 0.5.0, changelog fragments, tier S trimmed
  ...
  accepted at user review. (a) `docs/90_record/00_completed_development.md`
...
release: [`docs/90_record/09_verification_baseline_0.5.0.md`](docs/90_record/09_verification_baseline_0.5.0.md).
...
- **Distributed empennage loads** — `sloads/modules/tail_span.py`,
  ...
  Loads** page (mission phase 4 step 7; [plan 09](docs/25_notes/09_distributed_empennage_loads_plan.md)
...
- **M4-1 — fuselage body loads now close the moment, not just the force**
  ...
  **Export** page's Fuselage caption branches artifact/closed. The FAR 23 flight
  ...
  Full record: `docs/90_record/00_completed_development.md` and the design note
...
- **M4-20 step 7 — the Imperial baseline is frozen, and M4-20 is closed.**
  ...
  `docs/90_record/00_completed_development.md`, D-19…D-22 to
...
- **Three spent plan documents moved from `docs/30_future/` to
  ...
  `02_gui_workflow_plan.md` → `25_notes/05_phase_d_gui_workflow_plan.md`
  (Phase D, executed; nav grouping superseded by Phase G), `04_m3-1_rename_procedure.md`
  → `90_record/06_m3-1_rename_procedure.md` (executed with 0.3.0), and
  `06_m4_maintainability_sequence_plan.md` →
  `25_notes/07_m4_maintainability_sequence_plan.md` (all six steps shipped
...
- **Backlog hygiene sweep** (docs only, no open work dropped).
  ...
  `docs/25_notes/03_resolved_decisions.md` (open **D-5** stays in the
  ...
  `docs/25_notes/04_m4-1_body_moment_closure.md`), leaving the decided approach
...
- **Flight Envelope page no longer destroys unedited `flight_loads` data**
  ...
  convention (`docs/25_notes/05_phase_d_gui_workflow_plan.md §5`). Regression tests in
...
- **`docs/90_record/01_verification_baseline_0.2.0.md`** (release step R4,
...
- **Documentation structure** — `docs/` reorganised by type
  ...
  `docs/30_future/00_backlog.md`, and `docs/90_record/00_completed_development.md`.
...
See `docs/90_record/00_completed_development.md` for the full record.
