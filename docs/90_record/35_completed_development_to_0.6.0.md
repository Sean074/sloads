...
`docs/25_notes/27_lra_model_implementation_note.md` (note 24 §7's
...
`../25_notes/03_resolved_decisions.md`; `SurfaceInput.sob_y_in` (schema **v51**, additive)
...
`CG4`). Design note:
[`../25_notes/26_pri5_fixture_loadings_note.md`](../25_notes/26_pri5_fixture_loadings_note.md).
...
[`../25_notes/25_d25_cgcase_loading_note.md`](../25_notes/25_d25_cgcase_loading_note.md).
...
`05_step_g8_summary_report_plan.md` §6, `../25_notes/03_resolved_decisions.md` (D-24).
...
[`plan 09 §10`](../25_notes/09_distributed_empennage_loads_plan.md).
