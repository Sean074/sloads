...
([`../25_notes/33_l7_lateral_body_aero_note.md`](../25_notes/33_l7_lateral_body_aero_note.md)): every
...
- Nacelle aerodynamic lift/drag in the slipstream — belongs to the body-drag
  carrier seam ([`20_body_drag_carrier_note.md`](../25_notes/24_body_drag_carrier_note.md)).
...
v50, note [`22_d25_cgcase_loading_note.md`](../25_notes/25_d25_cgcase_loading_note.md)) —
