...
[`07_export_equilibrium_invariant_plan.md`](../25_notes/15_export_equilibrium_invariant_plan.md)
(per-deck resultant check; §9 there is the item this plan supersedes),
[`10_sbeam_roundtrip_ci_harness_plan.md`](../25_notes/17_sbeam_roundtrip_ci_harness_plan.md)
