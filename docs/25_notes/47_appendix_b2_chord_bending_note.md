...
§3.3, `docs/25_notes/44_oracle_report_note.md` OR-55, note 46 OR-69/OR-70,
...
- `docs/25_notes/46_applied_wing_load_set_note.md` §2: OR-70 marked
  **superseded by OR-71**, the row kept rather than deleted.
- `docs/25_notes/44_oracle_report_note.md`: OR-55's `Mzz` sentence marked
