...
| 3. Wing Loads (subsections, appendix lettering) | 2026-09-01 | `test_oracle_report.py::test_the_wing_section_renders_its_five_subsections_numbered_by_the_owner`, `::test_wing_loads_is_appendix_b_and_the_reservation_held_its_place`, `::test_the_input_echo_is_gone_and_nothing_points_at_it` |
...
| 4.5 An unplaceable wing post refuses by name and the section states its absence (OR-98 as re-cut by design note 64 §8 ruling 1, 2026-09-21) | 2026-09-06 | `test_oracle_report_fuselage.py::test_an_unplaceable_wing_post_refuses_and_the_section_states_its_absence` |
