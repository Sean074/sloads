...
`DEVELOPMENT_PROCESS.md` §0; rule 1's working-alone branch). The nine rulings
in §2.2 are the owner's, taken in session on 2026-09-10 (rulings 7–9 on
review); the decisions D-56.1…D-56.8 follow from them. Raised as
