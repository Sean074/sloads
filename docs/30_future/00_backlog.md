...
> filed as **#289** behind #288 (same shared ordinal) and **shipped 2026-09-18** (`113c9cd`) as the one-model step; the variants step is **#292**, on which #260's E6 and the fixtures' hand-entered `wing_mass.cases` wait.
