...
**This note carries the owner's OR-15 admission.** `sloads/modules/engine.py` is
frozen for 0.8.2 (note 44 OR-13). The owner granted OR-15 in session on
2026-09-07 **for the torque sign and nothing else** — not a refactor, not a
rename, not formatting in the same file. The permission is recorded here, cited
in the commit, and lapses with the step.
