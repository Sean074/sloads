- **Every engine-mount condition states its own point of application (#210, tier S, 2026-09-21).**
  ...
  is the identity it was filed to become and refuses a condition without a point
  rather than filling it. A pure couple and a three-point condition each state one
  ...
  every condition at its engine's combined CG, no two engines sharing one, the
  boundary refusing a pointless condition) plus
